...
unzip consul_1.9.4_linux_amd64.zip -d .
...
# install CNI plugins
curl -L -o cni-plugins.tgz https://github.com/containernetworking/plugins/releases/download/v0.9.1/cni-plugins-linux-amd64-v0.9.0.tgz
mkdir -p /opt/cni/bin
